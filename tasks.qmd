...
1.  For one of your comparisons search for binary LSVs with |deltaPSI| $\ge$ 0.1 and Confidence Threshold $\ge$ 0.9. If you can't find events lower the deltaPSI threshold. 
...
2.  Take for each of the five LSVs also screenshots for your other comparison(s) (use the LSV identifier).
...
Repeat the analyses in part2_AS_at_LSV_level.pdf for your comparisons.
